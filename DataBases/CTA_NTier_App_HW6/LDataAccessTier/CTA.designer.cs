...
namespace LDataAccessTier
{
    ...
    partial void DeleteStopDetail(StopDetail instance);
		...
		public CTADataContext() : 
				base(global::LDataAccessTier.Properties.Settings.Default.CTAConnectionString, mappingSource)
		{
			OnCreated();
		}
		...
		[global::System.Data.Linq.Mapping.FunctionAttribute(Name="dbo.InsertRidershipsFromXML")]
		public int InsertRidershipsFromXML([global::System.Data.Linq.Mapping.ParameterAttribute(DbType="NVarChar(MAX)")] string xmlstring)
		{
			IExecuteResult result = this.ExecuteMethodCall(this, ((MethodInfo)(MethodInfo.GetCurrentMethod())), xmlstring);
